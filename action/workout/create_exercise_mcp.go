...
var CreateExerciseMCPDefinition = mcp.Tool{
...
func CreateExercise(ctx context.Context, _ *mcp.CallToolRequest, input CreateExerciseInput) (*mcp.CallToolResult, CreateExerciseOutput, error) {
	...
	// 1. Validate input
	if err := validateCreateExerciseInput(input); err != nil {
...
func validateCreateExerciseInput(input CreateExerciseInput) error {
